...
interface CourseDisplayProps {
  ...
  isChangingCourse?: boolean; // New prop
}

export default function CourseDisplay({ title, instructions, isComplete, onNextCourse, isLastCourse, onClaimCertificate, isChangingCourse }: CourseDisplayProps) {
        ...
        {isComplete && (
          <div className="mt-4">
            ...
            {isLastCourse ? (
              ...
              <Button onClick={onNextCourse} className="mt-2 w-full" disabled={isChangingCourse}>
                {isChangingCourse ? (
